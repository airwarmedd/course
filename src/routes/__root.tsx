  ...
  return (
    <Shell>
      <div className="mx-auto max-w-3xl px-6 py-24 text-center">
        ...
        <a
          href="/"
          className="mt-8 inline-block border border-ink px-5 py-2 hover:bg-ink hover:text-paper transition-colors"
        >
          Return home
        </a>
      </div>
    ...
    <Shell>
      <div className="mx-auto max-w-3xl px-6 py-24 text-center">
        ...
        <div className="mt-8 flex justify-center gap-3">
          ...
          <a
            href="/"
            className="border border-border px-5 py-2 hover:bg-secondary transition-colors"
          >
            Go home
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Robotics for Drift Growth — The Full Course" },
      {
        name: "description",
        content:
          "A 4-week, 20-lesson course for growth marketers learning enough robotics to understand Drift's users and position the product on evidence.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;500;600&family=Newsreader:ital,opsz,wght@0,6..72,400;0,6..72,500;0,6..72,600;1,6..72,400&family=Space+Grotesk:wght@400;500;600;700&display=swap",
      },
    ],
  }),
